...
export const UserIcon = () => {
    ...
    return (
        ...
        <svg 
            ...
            xmlns="http://www.w3.org/2000/svg"
        >
            <path d="M5 5.5a2.5 2.5 0 115 0 2.5 2.5 0 01-5 0z" fill="currentColor"></path>
            <path 
                fillRule="evenodd" 
                clipRule="evenodd"
...
export const MinusIcon = () => {
    ...
    return(
        <svg 
            ...
            xmlns="http://www.w3.org/2000/svg"
        >
            <path stroke="currentColor"  fillRule="evenodd" clipRule="evenodd" d="M14 8H1V7h13v1z" fill="currentColor"></path>
        </svg>
    )
...
export const PlusIcon = () => {
    ...
    return(
        <svg 
            ...
            xmlns="http://www.w3.org/2000/svg"
        >
            <path stroke="currentColor"  fillRule="evenodd" clipRule="evenodd" d="M7 7V1h1v6h6v1H8v6H7V8H1V7h6z" fill="currentColor">
            </path>
        </svg>
    )
